...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_MSG_RPCREQMSG_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_MSG_RPCREQMSG_H_
...
/*!
 * @brief This class represents the structure RpcReqMsg defined by the user in
 * the IDL file.
 * @ingroup RpcReqMsg
 */
class RpcReqMsg : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   * @param x Reference to the object booster_msgs::msg::RpcReqMsg that will be
   * copied.
   */
  eProsima_user_DllExport RpcReqMsg(const RpcReqMsg& x);
   ...
   * copied.
   */
  eProsima_user_DllExport RpcReqMsg(RpcReqMsg&& x) noexcept;
   ...
   * copied.
   */
  eProsima_user_DllExport RpcReqMsg& operator=(const RpcReqMsg& x);
   ...
   * copied.
   */
  eProsima_user_DllExport RpcReqMsg& operator=(RpcReqMsg&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x booster_msgs::msg::RpcReqMsg object to compare.
   */
  eProsima_user_DllExport bool operator==(const RpcReqMsg& x) const;
 ...
 public:
  ...
  eProsima_user_DllExport RpcReqMsg();

  eProsima_user_DllExport ~RpcReqMsg() override;
...
#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_MSG_RPCREQMSG_H_
