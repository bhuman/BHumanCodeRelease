...
{
    const bool isNull = constraint.isNull();
    const float left   = isNull ? FLT_MIN : static_cast<float>(constraint.left());
    const float right  = isNull ? FLT_MAX : static_cast<float>(constraint.left() + constraint.width());
    const float top    = isNull ? FLT_MIN : static_cast<float>(constraint.top());
    const float bottom = isNull ? FLT_MAX : static_cast<float>(constraint.top() + constraint.height());
    const float width  = isNull ? FLT_MAX : static_cast<float>(constraint.width());
    const float height = isNull ? FLT_MAX : static_cast<float>(constraint.height());
