...
public:
    ...
    Q_DECL_CONSTEXPR quint8 red8()   const { return static_cast<quint8>(div_257(red())); }
    Q_DECL_CONSTEXPR quint8 green8() const { return static_cast<quint8>(div_257(green())); }
    Q_DECL_CONSTEXPR quint8 blue8()  const { return static_cast<quint8>(div_257(blue())); }
    Q_DECL_CONSTEXPR quint8 alpha8() const { return static_cast<quint8>(div_257(alpha())); }
    ...
    Q_DECL_RELAXED_CONSTEXPR QRgba64 premultiplied() const
    {
        ...
        const quint16 r = static_cast<quint16>(div_65535(red()   * a));
        const quint16 g = static_cast<quint16>(div_65535(green() * a));
        const quint16 b = static_cast<quint16>(div_65535(blue()  * a));
        return fromRgba64(static_cast<quint8>(r), static_cast<quint8>(g), static_cast<quint8>(b), static_cast<quint8>(a));
    }
