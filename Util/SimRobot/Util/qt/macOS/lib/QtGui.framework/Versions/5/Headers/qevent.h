...
public:
    ...
    inline int x() const { return static_cast<int>(p.x()); }
    inline int y() const { return static_cast<int>(p.y()); }
    inline int globalX() const { return static_cast<int>(g.x()); }
    inline int globalY() const { return static_cast<int>(g.y()); }
#endif
    inline const QPointF &posF() const { return p; }
