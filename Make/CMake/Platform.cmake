...
set(PLATFORM_SOURCES
    ...
    "${PLATFORM_ROOT_DIR}/${OS}/Semaphore.cpp"
    "${PLATFORM_ROOT_DIR}/${OS}/SoundPlayer.${SOUNDPLAYER_SUFFIX}"
    "${PLATFORM_ROOT_DIR}/${OS}/SoundPlayer.h"
    "${PLATFORM_ROOT_DIR}/${OS}/Thread.cpp")
...
if(BUILD_DESKTOP)
  ...
  target_link_libraries(Platform${TARGET_SUFFIX} PUBLIC -lpthread-2.31)
  target_link_libraries(Platform${TARGET_SUFFIX} PRIVATE -lrt-2.31)
