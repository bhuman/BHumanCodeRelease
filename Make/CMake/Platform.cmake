...
if(BUILD_DESKTOP)
  ...
  if(BUILD_NAO)
    ...
    target_link_libraries(Platform${TARGET_SUFFIX} PRIVATE Booster::flite::flite_cmu_us_slt Booster::flite::flite_usenglish Booster::flite::flite_cmulex Booster::flite::flite)
    target_link_libraries(Platform${TARGET_SUFFIX} PRIVATE Booster::ALSA::ALSA)
  endif()
