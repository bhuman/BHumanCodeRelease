...
class LocalizationTeamBallProvider2014 : public LocalizationTeamBallProvider2014Base
{
  ...
  struct BallObservation
  {
    ...
    Pose2D robotPose;               /**< The observer's pose on the field */
    Vector2<> ballPositionAbsolute; /**< The ball's position on the field in absolute coordinates */
    ...
    float cameraZ;                  /**< The height of the observer's camera */
  };
