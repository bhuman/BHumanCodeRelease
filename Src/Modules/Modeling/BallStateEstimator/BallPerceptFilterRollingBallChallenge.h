/**
 * @file BallPerceptFilterRollingBallChallenge.h
 *
...
MODULE(BallPerceptFilterRollingBallChallenge,
{,
...
/**
 * @class BallPerceptFilterRollingBallChallenge
 *
 * Some basic techniques to get rid off false positive BallPercepts.
 */
class BallPerceptFilterRollingBallChallenge : public BallPerceptFilterRollingBallChallengeBase
{
public:
  /** Constructor */
  BallPerceptFilterRollingBallChallenge();
