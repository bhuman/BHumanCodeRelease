...
void CalibrationStand::update(StandArmRequest& standArmRequest)
{
  ...
  standArmRequest.angles[Joints::lShoulderRoll] = jointCalibrationMode ? 90_deg : 10_deg;
  ...
  standArmRequest.angles[Joints::rShoulderRoll] = jointCalibrationMode ? -90_deg : -10_deg;
