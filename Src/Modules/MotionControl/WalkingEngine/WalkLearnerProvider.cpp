...
MAKE_MODULE(WalkLearnerProvider, motionControl);
  ...
  if(theWalkModifier.numOfGyroPeaks > 0 && speed > 25.f)
  {
    ...
    if(learnIteration >= theWalkModifier.numOfGyroPeaks)
    {
      ...
      if(number > 1.f)
      {
        ...
        if(averageDif != 0.f)
          averageDif = averageDif / theWalkModifier.numOfGyroPeaks;
        ...
        if(phaseLearn == 0)
        {
          ...
          gyroForwardBalanceFactor += averageDif * theWalkModifier.balanceChangeFactor;
      ...
      else
      {
        ...
        if(phaseLearn == 0)
        {
          ...
          gyroBackwardBalanceFactor += averageDif * theWalkModifier.balanceChangeFactor;
