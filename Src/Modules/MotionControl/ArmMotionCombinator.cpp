...
void ArmMotionCombinator::update(ArmJointRequest& armJointRequest)
{
  ...
  auto combinateArmMotions = [&](Arms::Arm const arm)
  {
    ...
    MotionCombinator::copy(*armJointRequests[theArmMotionSelection.targetArmMotion[arm]], armJointRequest, theStiffnessSettings, startJoint, endJoint);
    ...
    else
    {
      ...
      for(int i = 0; i < ArmMotionSelection::numOfArmMotions; ++i)
      {
        ...
        {
          MotionCombinator::interpolate(*armJointRequests[i], *armJointRequests[theArmMotionSelection.targetArmMotion[arm]], theArmMotionSelection.armRatios[arm][i], armJointRequest, interpolateStiffness, theStiffnessSettings, lastJointAngles, startJoint, endJoint);
        }
      }
    }
