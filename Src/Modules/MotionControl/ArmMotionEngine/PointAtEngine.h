...
*
* This file declares and module to provide the PointAtEngineOutput.
*
...
* that way a selected arm is smouthly pointing at a specified 3d position
...
{,
  ...
  {,
    ...
    (float)(15.f) smoothnessValue, /**< The higher this value that slower the arm moves*/
  }),
});
...
public:
  /**
    ...
    */
  void update(PointAtEngineOutput& pointAtEngineOutput);
...
private:
  /**
    ...
    * will calculate the right joint angles to point at position specified
  ...
  /**
    ...
    * @param pointPosition, the 3d position to point at (relativ to torso)
