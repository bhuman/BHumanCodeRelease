...
{,
  ...
  PROVIDES_WITH_MODIFY(CameraResolutionRequest),
...
class CameraCalibratorV6 : public CameraCalibratorV6Base
{
private:
  /**
  ...
  */
  ...
  GaussNewtonOptimizer<Sample, CameraCalibratorV6>* optimizer = nullptr; /**< A pointer to the currently used optimizer, or NULL if there is none. */
