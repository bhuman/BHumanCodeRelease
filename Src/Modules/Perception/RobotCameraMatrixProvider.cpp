...
{
  robotCameraMatrix.computeRobotCameraMatrix(theRobotDimensions, theFilteredJointData.angles[JointData::HeadYaw], theFilteredJointData.angles[JointData::HeadPitch], theCameraCalibration, theCameraInfo.camera == CameraInfo::upper);
}
