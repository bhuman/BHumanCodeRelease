/**
 * @file OrbbecProvider.h
 *
 * This file declares a module that grabs images from the Orbbec camera sensor.
 *
 * @author Thomas Röfer
 */
...
class OrbbecProvider : public OrbbecProviderBase
{
  static thread_local OrbbecProvider* theInstance; /**< The only instance of this module. */
