...
{,
  ...
  DEFINES_PARAMETERS(
  {,
    (unsigned)(1000) unstiffHeadButtonPressDuration, /**< How long the head buttons need to be pressed until the robot transitions to unstiff (in ms). Must be at least as long as KeyStateEnhancer::releaseTimeOut. */
