...
public:
  ...
  {,
    ...
    (std::vector<float>)({0, 0, 0, 0}) angles,                  /**< contains the target arm joints for each arm. Those values are ignored if moveArm is false */
    (std::vector<int>)({HardnessData::useDefault,
                       HardnessData::useDefault,
                       HardnessData::useDefault,
                       HardnessData::useDefault}) hardness,    /**< contains hardness data for this arm motion. Those values are ignored if moveArm is false*/
  }),
