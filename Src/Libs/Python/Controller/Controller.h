...
public:
   ...
   */
  void addPlayer(const std::string& name, int teamNumber, Settings::TeamColor fieldPlayerColor, Settings::TeamColor goalkeeperColor, int playerNumber, const std::string& location, const std::string& scenario, float motionCycleTime, Settings::RobotType robotType);
