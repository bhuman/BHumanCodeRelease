...
double ObjectCNSStereoDetector::response(const Image<CNSResponse>& cns, const Eigen::Isometry3d& object2World) const
{
...
double ObjectCNSStereoDetector::response(const Image<CNSResponse>& cns, const CodedContour& ct) const
{
  //  int64 t0 = cv::getTickCount();
...
bool ObjectCNSStereoDetector::refine1Dimension(const Image<CNSResponse>& cns,
    IsometryWithResponse& object2World, double stepInPixel, int dimension) const
{
...
void ObjectCNSStereoDetector::refine(const Image<CNSResponse>& cns, IsometryWithResponse& object2World, int iterationCtr) const
{
