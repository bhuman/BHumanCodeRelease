...
namespace ColorModelConversions
{
   ...
   */
  static constexpr float yCoeffR = 0.299f; // BT 601-YUV: 0.299f
  static constexpr float yCoeffG = 0.587f; // BT 601-YUV: 0.587f
  static constexpr float yCoeffB = 0.114f; // BT 601-YUV: 0.114f

  static constexpr float uCoeff = 0.564f;  // BT 601-YUV: 0.564f
  static constexpr float vCoeff = 0.713f;  // BT 601-YUV: 0.713f
