...
public:
  ...
  {
    arc, ellipse, line, origin, polygon, rectangle, text, tip, robot, spot, gridMono, gridRGBA, gridRectangleRGBA
  };
  ...
  /** Stores a GridMono */
  struct GridMono : public Element
  {
    int x, y;
    int cellSize, cellsX, cellsY;
    ColorRGBA baseColor;

    GridMono() : Element(ElementType::gridMono) {}
  };

  /** Stores a GridRGBA */
  struct GridRGBA : public Element
  {
    int x, y;
    int cellSize, cellsX, cellsY;

    GridRGBA() : Element(ElementType::gridRGBA) {}
  };

  /** Stores a GridRectangleRGBA */
  struct GridRectangleRGBA : public Element
  {
    int x, y;
    int width, height, cellsX, cellsY;

    GridRectangleRGBA() : Element(ElementType::gridRectangleRGBA) {}
  };
