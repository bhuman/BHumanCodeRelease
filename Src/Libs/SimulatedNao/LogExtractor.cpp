...
bool LogExtractor::save(const std::string& fileName, const TypeInfo* typeInfo, const Settings& settings)
{
  ...
  if(file.exists())
  {
    ...
    LoggingTools::writeSettings(file, settings);
...
bool LogExtractor::split(const std::string& fileName, const TypeInfo* typeInfo, const Settings& settings, int split)
{
