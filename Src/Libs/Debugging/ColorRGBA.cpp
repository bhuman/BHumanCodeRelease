...
const ColorRGBA ColorRGBA::green(0, 192, 0);
const ColorRGBA ColorRGBA::blue(0, 0, 255);
const ColorRGBA ColorRGBA::yellow(224, 192, 0);
const ColorRGBA ColorRGBA::cyan(0, 192, 224);
const ColorRGBA ColorRGBA::magenta(192, 0, 192);
