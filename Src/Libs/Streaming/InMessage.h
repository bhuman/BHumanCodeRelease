...
public:
  ...
  /**
   * The method returns the message id of the current message.
   * @param raw Disable ID mapping. If set, the result must not be interpreted as \c MessageID.
   * @return The message id.
   */
  MessageID getMessageID(bool raw = false) const;
