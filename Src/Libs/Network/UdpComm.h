...
public:
  ...
  /**
   * The function returns the timestamp (in B-Human system time)
   * when the last packet returned by \c read was received.
   * @return Timestamp of the last packet.
   */
  unsigned getLastReadTimestamp() const;
