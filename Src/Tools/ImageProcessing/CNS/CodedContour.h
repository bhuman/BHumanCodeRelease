...
public:
  ...
  void evaluateX16Y16(signed short responseBin[16][16], const CNSImage& img, int x = 0, int y = 0) const;

  //! See \c evaluateX16Y16
  void evaluateX8Y8(signed short responseBin[8][8], const CNSImage& img, int x = 0, int y = 0) const;
